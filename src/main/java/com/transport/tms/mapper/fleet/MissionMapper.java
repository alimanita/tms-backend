...
public class MissionMapper {
    ...
    public MissionResponse toResponse(Mission mission) {
        ...
        return new MissionResponse(
                ...
                mission.getTauxCommission(),
                mission.getMontantCommission(),
                mission.getMontantReversePartenaire(),
                mission.getExterneCamion(),
                mission.getExterneChauffeur(),
                mission.getStatutSousTraitance() != null ? mission.getStatutSousTraitance().name() : null,
                mission.getStatut(),
